...
async fn sell_order_insufficient_surplus() {
    let api = mock::http::setup(vec![mock::http::Expectation::Get {
        ...
        res: json!({
            ...
            // Order expects 230, swap returns 230 (no surplus)
            "buyAmount": "230000000000000000000",
            "transaction": {
                "to": "0xdef1c0ded9bec7f1a1670819833240f027b25eff",
                "data": "",
                "gas": "111000",
            },
            "issues": {
                "allowance": {
    ...
    let engine = tests::SolverEngine::new(
        "zeroex",
        zeroex::config_with(&api.address, "relative-minimum-surplus = '0.01'"),
    )
    .await;
...
async fn sell_order_with_sufficient_surplus() {
    let api = mock::http::setup(vec![mock::http::Expectation::Get {
        ...
        res: json!({
            ...
            // Order expects 230, with 1% surplus that's 232.3, swap returns 235
            "buyAmount": "235000000000000000000",
            "transaction": {
                "to": "0xdef1c0ded9bec7f1a1670819833240f027b25eff",
                "data": "",
                "gas": "111000",
            },
            "issues": {
                "allowance": {
